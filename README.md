...
# The Ultimate vimrc - Replace pathogen with vim-plug as Vim plug manager
...
```
Python.h no this file issue fix way:
...
* Remove any lines that reference `~/.config/nvim_runtime` in your `~/.config/nvim/init.vim`
